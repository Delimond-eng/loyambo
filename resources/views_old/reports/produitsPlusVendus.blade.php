                ...
                <div class="col-12">
                    <div class="box">
                        <div class="box-header with-border p-5 text-center">
                            <h4 class="box-title">Produits les plus vendus par emplacement</h4>
                            <p class="text-muted">Veuillez choisir un emplacement pour afficher les produits les plus vendus.</p>
                        </div>
                        <div class="box-body">
                            ...
                            <div class="emplacement-buttons-container">
                                <div class="d-flex flex-wrap justify-content-center gap-2" id="emplacementButtons">
                                    @foreach($emplacements as $emplacement)
                                        <a href="{{ route('reports.produits.plusVendus.details', ['emplacement_id' => $emplacement->id]) }}" 
