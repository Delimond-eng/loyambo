					...
					<div class="box-body">
						<div class="row">
							<div class="col-md-6 col-sm-3 col-lg-2 col-6" v-for="(table, i) in allTables">
								<a href="{{ url("/orders.interface") }}" class="box">
									<div class="box-body ribbon-box">
										...
										<img v-if="table.emplacement.type !== 'hôtel'" :src="table.statut==='libre' ? 'assets/images/table4.avif' : 'assets/images/table5.png'" class="img-fluid">
