                ...
                <div class="col-xl-12">
                    <div class="box">
                        <div class="box-head d-flex justify-content-between align-items-center p-3">
                            <h4 class="mb-0">
                                Chambres Occupées
                                <small class="text-muted d-block">Liste des chambres occupées</small>
                            </h4>
                        ...
                        <div class="box-body">
                            <div class="row justify-content-center">
                                @forelse($chambresoccupees as $chambre)
                                ...
                                <div class="col-12 text-center py-5">
                                    ...
                                    <h5 class="text-muted">Aucune chambre occupée</h5>
                                </div>
                                @endforelse
                            </div>
                        </div>
...
<!-- Modals -->
@foreach($chambresoccupees as $chambre)
