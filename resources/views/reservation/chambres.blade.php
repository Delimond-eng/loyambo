                        ...
                        <div class="box-body border-bottom">
                            ...
                            <div class="row d-flex justify-content-center pt-20" v-if="allChambres.length > 0">
                                <div class="col-md-6 col-sm-3 col-lg-2 col-6" v-for="(chambre, i) in allChambres">
                                    <a href="#" @click="chambre.statut === 'réservée' ?  triggerActionReservationModal(chambre) : triggerOpenCreateReservationModal(chambre)" class="box box-shadowed b-3 border-primary">
                                        <div class="box-body ribbon-box">
                                            ...
                                            <img v-if ="chambre.statut==='libre'" src="{{ asset('assets/images/bed-empty.png') }}" class="img-fluid">
                                            <img v-else src="{{ asset('assets/images/bed-2.png') }}" class="img-fluid">
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="flexbox flex-justified text-center">
                            ...
                            <button @click="occuperChambre(selectedChambre)" class="b-2 rounded border-danger text-danger btn py-20">
                                <p class="mb-0 fa-3x">
                                    <span v-if="isLoading" class="spinner-border"></span>
                                    <i v-else class="fa fa-bed"></i>
                                </p>
                                <p class="mb-0 fw-300">Occuper chambre</p>
                            </button>
                        </div>
                    </div>
                </div>
