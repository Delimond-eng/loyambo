                ...
                <div class="col-xl-12">
                    <div class="box">
                        <div class="box-head d-flex justify-content-between align-items-center p-3">
                            <h4 class="mb-0">
                                Chambres Libres
                                <small class="text-muted d-block">Liste des chambres disponibles</small>
                            </h4>
                        ...
                        <div class="box-body">
                            <div class="row justify-content-center">
                                @forelse($chambreslibres as $chambre)
                                <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                                    <div class="card chambre-card" onclick="openReservationsModal({{ $chambre->id }})" style="cursor: pointer; position: relative; overflow: hidden;">
                                        ...
                                        <div class="status-ribbon status-ribbon-free">
                                            <span>Libre</span>
                                        </div>
                                ...
                                <div class="col-12 text-center py-5">
                                    ...
                                    <h5 class="text-muted">Aucune chambre libre</h5>
                                </div>
                                @endforelse
                            </div>
                        </div>
