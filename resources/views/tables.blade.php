					...
					<div class="col-xl-6">
						<div class="box">
							<div class="box-header d-flex justify-content-between align-items-center" style="padding : 1.5rem">
								<h4 class="box-title">Les Tables
									<small class="subtitle">Listes des emplacements</small>
								</h4>
								<a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#myModal" class="btn btn-primary text-center">+ Nouvelle table</a>					
							</div>
									...
									<table class="table no-border table-vertical-center">
										...
										<tbody>
											...
											<tr class="border-bottom">
												<td>
													<a href="#" class="text-dark fw-600 hover-primary fs-16 fw-700">Table {{ $i }}</a>
													<span class="text-fade d-block">TAB{{ $i+1 }}</span>
												</td>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" id="myModalLabel">Création table</h4>
						...
						<div class="form-group">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control ps-15 bg-transparent"
                                    placeholder="Libellé de la table">
                            </div>
                        </div>
						<div class="form-group">
                            <div class="input-group mb-3">
